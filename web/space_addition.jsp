            ...
            <div id="colorlib-main">
                <div class="colorlib-contact">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            <center><h2>Space Addition</h2></center>
                            <br><br>
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <div class="form-group">
                                                &nbsp;&nbsp;<label>Name :</label>
                                                <input type="text" class="form-control" name="loc_name" placeholder="Enter location name" required="required">
                                            </div>
                              
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Slots Availability :</label>
                                                <input type="text" class="form-control" name="slots" placeholder="Enter number of slots" required="required">
                                            </div>
                                            <div class="form-group">
