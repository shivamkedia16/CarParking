                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form action="user_reg" method="post">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="submitBtn" class="btn btn-success btn-md">Sign Up</button>
                                            </div>
                                            
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Enter OTP :</label>
                                                <input type="password" class="form-control" name="otp" placeholder="Enter Your OTP"><br>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" name="verifyBtn" class="btn btn-success btn-md">Verify</button>
                                            </div>
