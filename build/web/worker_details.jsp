            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        ...
                        <li class="colorlib-active"><a href="worker_details.jsp">Worker Details</a></li>
                ...
                <div class="colorlib-contact">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            ...
                            <center><a href="worker_addition.jsp" class="btn btn-success btn-md"><center>ADD NEW WORKER</center></a></center>
                            <br>                              </br>
                            <div class="col-lg-12">
                                <table id="customers">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=rs.getString("Rating")%></td>
                                         ...
                                         <td><%=x.calculate(Integer.parseInt(rs.getString("Specialization")))%></td>
                                        <td><%=rs.getString("Slot")%></td>
                                        <td>
                                        <form  action="remove_worker.jsp" method="post">
                                            
                                            <div class="form-group btn-container">
                                                <button type="submit" value="<%=rs.getString("id")%>" name="del" class="btn btn-success btn-md">Delete</button>&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                        </form>
                                        </td>
                                    </tr>
