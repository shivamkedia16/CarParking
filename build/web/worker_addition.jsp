            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        ...
                        <li><a href="user_details.jsp">Worker Details</a></li>
            ...
            <div id="colorlib-main">
                <div class="colorlib-contact">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            <center><h2>Worker Addition</h2></center>
                            <br><br>
                                    ...
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form action="add_worker" method="post">
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Name :</label>
                                                <input type="text" class="form-control" name="w_name" placeholder="Enter Your Name" required="required">
                                            </div>
                              
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Email ID :</label>
                                                <input type="email" class="form-control" name="w_email" placeholder="Enter Your Email ID" required="required">
                                            </div>
                                             <div class="form-group">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="slot" placeholder="Enter worker slot" required="required">
                                            </div>
                                            <div class="form-group">
