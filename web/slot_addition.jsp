            ...
            <div id="colorlib-main">
                <div class="colorlib-contact">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            <center><h2>Slot Availability for <%=loc%></h2></center>
                            <br><br>
                            <div class="col-md-1">
                            </div>
                            <%
                            ...
                            <div class="col-md-6 col-md-push-2">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form  action="slot_update.jsp" method="post">
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Number of Slots Available :</label>
                                                <input type="text" name="ll" class="form-control" value="<%=String.valueOf(rs.getInt("slot_available"))%>">
                                            </div>
                                            <div class="form-group">
